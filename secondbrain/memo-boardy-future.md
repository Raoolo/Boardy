...
- 🟢 Cinque nuovi item "spice" aggiunti il 2026-05-06: empty-state chat
  ...
  `/random-game`. Tutti documentati in `../docs/TODO.md` con costo stimato e
  pointer ai file.
